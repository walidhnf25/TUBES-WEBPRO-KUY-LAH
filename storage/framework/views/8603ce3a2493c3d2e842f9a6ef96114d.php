...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/Alamat.css')); ?>" rel="stylesheet">
</head>
</head>
<body>
    <header>
        <div class="box shadow p-3 d-flex justify-content-between align-items-center">
            ...
            <div class="menu d-flex align-items-center">
                ...
                <a href="<?php echo e(url("alamat")); ?>" class="active">Alamat</a>
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('assets/jss/Alamat.js')); ?>"></script>
</body>
</html>
<?php /**PATH D:\Tugas Kuliah Semester 5\aplikasi-event-kampus-kelompok-skuyyla\resources\views/Alamat.blade.php ENDPATH**/ ?>