...
<body>
    ...
    <form method="POST" action="tambah">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" name="namaEvent" type="text" placeholder="Nama Event" value="<?php echo e(isset($data)?$data->namaEvent:''); ?>"  />
        </div>
        <div class="mb-3">
            <label class="form-label" for="tanggalMulai">Tanggal Mulai</label>
            <div class="row">
                <div class="col">
                    <input type="datetime-local" name="tanggalMulai" class="form-control" value="<?php echo e(isset($data)?$data->tanggalMulai:''); ?>" />
                </div>
            </div>
        </div>
        <div class="mb-3">
            ...
            <div class="row">
                <div class="col">
                    <input type="datetime-local" name="tanggalAkhir" class="form-control" value="<?php echo e(isset($data)?$data->tanggalAkhir:''); ?>"/>
                </div>
            </div>
        </div>
        <div class="mb-3">
            <label class="form-label" for="harga">Harga</label>
            <input class="form-control" name="harga" type="number" placeholder="<Opsional>" value="<?php echo e(isset($data)?$data->harga:''); ?>" />
        </div>
        <div class="mb-3">
            <label class="form-label" for="deskripsi">Deskripsi</label>
            <textarea class="form-control" name="deskripsi" type="text" placeholder="deskripsi" style="height: 10rem;" value="<?php echo e(isset($data)?$data->deskripsi:''); ?>"></textarea>
        </div>
        <div class="d-grid">
...
<?php /**PATH C:\Users\Muhammad Yaasin Rafi\Documents\Mata Kuliah\Semester 5\aplikasi-event-kampus-kelompok-skuyyla\resources\views/UploadEvent.blade.php ENDPATH**/ ?>